package com.aemerse.mlkit.productsearch
...
class SearchedObject(
    ...
    private val objectThumbnailCornerRadius: Int = resources.getDimensionPixelOffset(com.aemerse.mlkit.R.dimen.bounding_box_corner_radius)
